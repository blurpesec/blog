...
import AssociatedLinks from '../misc/associatedLinks';
            ...
            <article>
              ...
              <div className="lg:flex lg:justify-between" data-sticky-container>
                ...
                <aside className="relative lg:block lg:w-72 lg:ml-20 shrink-0">
                  <div>
                    <h4 className="text-lg font-bold leading-snug tracking-tight mb-4">Associated</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4">
                      {
                        (Object.keys(backlinks).length > 0) && (
                            <AssociatedLinks backlinks={backlinks} />
                        )
                      }
                    </div>
                  </div>
